...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withClientId("0").withName("Alice Pauline")
            ...
            .withLastMet("2021-09-01").withTags("friends")
            .withPhone("94351253").withRiskAppetite("3").withDisposableIncome("300").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withEmail("johnd@example.com")
            .withPhone("98765432").withRiskAppetite("3").withDisposableIncome("300")
            .withCurrentPlan("Prudential PRUShield").withLastMet("2021-09-01")
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withLastMet("2021-09-01").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends").withRiskAppetite("3")
            .withDisposableIncome("300").withCurrentPlan("Prudential PRUShield").withLastMet("2021-09-01").build();
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withCurrentPlan("Prudential PRUShield")
            .withLastMet("2021-09-01").withRiskAppetite("3").withDisposableIncome("300").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withCurrentPlan("Prudential PRUShield")
            .withLastMet("2021-09-01").withRiskAppetite("3").withDisposableIncome("300").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withCurrentPlan("Prudential PRUShield")
            .withLastMet("2021-09-01").withRiskAppetite("3").withDisposableIncome("300")
            .withAddress("chicago ave").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND)
            .withCurrentPlan(VALID_CURRENTPLAN_AMY).withLastMet(VALID_LASTMET_AMY).withDisposableIncome(VALID_DISPOSABLEINCOME_AMY)
            .withCurrentPlan(VALID_CURRENTPLAN_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withCurrentPlan(VALID_CURRENTPLAN_BOB)
